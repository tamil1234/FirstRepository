...
function show_accounts($instance_url, $access_token) {
    ...
    echo $url = "$instance_url/services/data/v20.0/query?q=" . urlencode($query);
...
function show_account($id, $instance_url, $access_token) {
	...
	$url = "$instance_url/services/apexrest/myaccount";
...
function SF_CREATE($instance_url,$access_token){

    echo $access_token."<br>";
	echo $instance_url."<br>";
    //$content = json_encode($data);
    $url = "$instance_url/services/apexrest/myaccount?id=0019000000SwxIbAAJ";
...
<html>
    ...
    <body>
        <tt>
			...
			$id='0019000000X307wAAB';
			//SF_CREATE($instance_url,$access_token);
